...
def run_female_freq50():
    ...
    out_dir = 'data/results/female_freq50'
    os.makedirs(out_dir, exist_ok=True)
    
    print(f">>> Initializing CVAE-SAGE for Female Characters (Freq > 50) (iters={iters})")
    ...
    # Filter female characters and then word freq > 50
    ...
    freq50_keys = word_freq[word_freq > 50].index.tolist()
    df_full = female_df[female_df['char_key'].isin(freq50_keys)].copy()
    
    print(f"    Total characters loaded (freq > 50): {len(df_full['char_key'].unique())}")
